...
import com.DisplayBookshelves.framework.base.BaseUIForSeleniumGrid;


/*----Pre-requirements --> Selenium Grid Hub and Node should be active-----*/

public class TestingOnSeleniumGrid extends BaseUIForSeleniumGrid{

	@BeforeClass
	public void setup() throws MalformedURLException {
		invokeChromeBrowserUsingGrid();
		openURL("HomePageURL");
	}
